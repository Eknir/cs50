...
function addMarker(place)
{
    ...
    //retrieve the data from articles (with parameter postal code)
    ...
    .done(function(data, textStatus, jqXHR) {
        ...
        content += '</ul>';
        // open infowindow at click
        marker.addListener('click', function() {
        new google.maps.InfoWindow({
            content: showInfo(marker, content)});
    });
    })
    ...
    },
    {
        ...
        templates: {
            suggestion: Handlebars.compile(
                "<div>" + "{{place_name}}, {{admin_name1}}, {{postal_code}}" +
                "</div>"
            )
        }
    });
